...
export default function RegistrationForm() {
  ...
  return (
    <section id="registration">
      ...
      <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 w-full max-w-2xl border border-white/20 drop-shadow-[0_4px_30px_rgba(255,255,255,0.6)]">
        <h2 className="text-5xl font-extrabold text-center mb-10 text-white drop-shadow-[0_4px_30px_rgba(255,255,255,0.6)]">
...
<input
  ...
  onChange={handleChange}
  required
  pattern="[6-9]{1}[0-9]{9}" // For Indian phone format (starts with 6-9)
...
/>
            ...
            <div>
              <label className="block font-semibold mb-2 text-white">Select Events (Optional):</label>
          ...
          <div className="text-center">
            <h3 className="text-3xl font-bold text-green-400">🎉 Registration Successful!</h3>
